...
public class Ellipse implements Shape{
    ...
    public Ellipse(Point start, Point end, Color primary, Color secondary, ShapeShadingType treatment){
    ...
    public void draw(Graphics graphics) {
        ...
        if (treatment.equals(ShapeShadingType.FILLED_IN)) {
            ...
            graphics.drawOval(topLeft.getX(), topLeft.getY(), width, height);
        ...
        for (Shape shape : Selected.get()) {
            if (this.equals(shape)) {
                ...
                graphics2D.drawOval(topLeft.getX()-3, topLeft.getY()-3, width + 6, height + 6);
            }
        }
    }
    ...
    @Override
    public Shape clone() {
        return new Ellipse(start, end, primary, secondary, treatment);
    }
